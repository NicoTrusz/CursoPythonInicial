...
def salir(nombre_archivo, formato, dic):
    with open(nombre_archivo, "w") as archivo:
        ...
        #************* verifico datos para guardar *********** me falta armar funcion guardar en txt o JSON

#************ VARIABLES ***************#
usuarios = {}
ingresos = 0
#************** MENU ******************#
while ingresos < 1 : # coloque un valor absurdo para poder ingresar en el bucle While y poder repetir la creacion de usuarios o el ingreso. Y rompo el bucle con la opcion 3 salir con break
    print("*" * 30)
    ...
    if opcion == "1": # crear usuario
        print("*" * 30)
        print("Opción >>> 1")
        n_usuario= input("Ingrese usuario: ")
        n_contraseña= input("Ingrese Contraseña: ")
        crear_usuario(n_usuario, n_contraseña, usuarios)
            # tengo que guardar en 1 pocicion 2 elementos o armar 2 listas para guardar usuario y contraceña ademas de armar una funcion para recorrer el verctor y verificar repetido
